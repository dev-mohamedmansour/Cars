	  ...
	  <div class="container">
		    ...
		    <div class="collapse navbar-collapse" id="navbarResponsive">
				 <ul class="navbar-nav ms-auto">
					   <li class="nav-item mx-0 mx-lg-1"><a
								  class="nav-link py-3 px-0 px-lg-3 rounded"
								  href="orderPages/orderDetails.php">Orders</a>
					   </li>
					   <li class="nav-item mx-0 mx-lg-1"><a
								  class="nav-link py-3 px-0 px-lg-3 rounded"
...
<header>
	  <div class="cd-bg-2" style="height: 100vh;">
		    <div class="container">
				 <div class="intro-text wow animate__fadeInUp"
					 data-wow-duration="1s" data-wow-delay="0.3s">
					   ...
					   <a href="#products" class="page-scroll btn btn-xl">Browse
							Our Collection</a>
				 </div>
		    </div>
	  </div>
...
<main id="services" class="cd-fixed-bg cd-main-content">
	  <div class="cd-bg-2">
		    <section>
				 <div class="container">
					   <div class="row1">
...
<section id="products" class="sec-product">
					 ...
					 data-wow-duration="1s" data-wow-delay="1.2s">
					   <form method="post" action="">
							<div class="content">
								  ...
								  <h4> Today's selling
									    price : $71,664 k</h4>
								  <button type="submit" name="jaguar"
										value="Jaguar E-Type">
					 ...
					 data-wow-duration="1s" data-wow-delay="1.5s">
					   <form method="post" action="">
							<div class="content">
								  ...
								  <h4> Today's selling
									    price : $122,095 k</h4>
								  <button type="submit" name="porsche"
										value="Porsche 911">
